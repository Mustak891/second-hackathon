...
export default function UpdateCamera(){
    ...
    const formvalidationSchema = yup.object({
      ...
      const { handleSubmit, values, handleChange, handleBlur, errors, touched } = useFormik({
        initialValues:{cameraname: localStorage.getItem('cameraname'), description: localStorage.getItem('description'),  price: localStorage.getItem('price'), image: localStorage.getItem('image'), id: localStorage.getItem('id')},
